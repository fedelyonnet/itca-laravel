                ...
                <div class="p-6 text-gray-100">
                    ...
                    @else
                        <div class="text-center py-12 bg-gray-700 rounded-lg">
                            ...
                            <h3 class="mt-2 text-sm font-medium text-gray-200">Selecciona un curso</h3>
                            <p class="mt-1 text-sm text-gray-300">Elige un curso del selector para gestionar sus modalidades.</p>
                        </div>
                    @endif
                </div>
            </div>
