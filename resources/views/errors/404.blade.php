...
<head>
    ...
    <meta name="description" content="ITCA - Página no encontrada">
    <title>404 - Página no encontrada | ITCA</title>
    ...
    <div style="min-height: 100vh; display: flex; flex-direction: column; align-items: center; justify-content: center; background: linear-gradient(135deg, #010C42 0%, #02115A 100%); color: white; padding: 20px; text-align: center;">
        <div style="max-width: 600px; width: 100%;">
            ...
            <div style="display: flex; gap: 15px; justify-content: center; flex-wrap: wrap;">
                <a href="{{ route('carreras') }}" style="display: inline-block; padding: 12px 30px; background-color: white; color: #010C42; text-decoration: none; border-radius: 8px; font-family: 'Montserrat', sans-serif; font-weight: 600; font-size: 16px; transition: all 0.3s ease;">
                    Ver Carreras
                </a>
                <a href="/" style="display: inline-block; padding: 12px 30px; background-color: transparent; color: white; text-decoration: none; border: 2px solid white; border-radius: 8px; font-family: 'Montserrat', sans-serif; font-weight: 600; font-size: 16px; transition: all 0.3s ease;">
                    Ir al Inicio
                </a>
            </div>
        </div>
