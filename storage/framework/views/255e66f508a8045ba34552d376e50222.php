...
<?php $component->withAttributes([]); ?>
                    ...
                    <div class="flex justify-between items-center mb-6">
                        <div>
                            ...
                            <p class="text-sm text-gray-400 mt-1">
                                Testimonios visibles: <?php echo e($testimonios->where('visible', true)->count()); ?>/8
                            </p>
                        </div>
                                        ...
                                        <tr>
                                            ...
                                            <td class="px-4 py-4">
                                                <div class="flex flex-col items-center space-y-1">
                                                    <button onclick="moverTestimonio(<?php echo e($testimonio->id); ?>, 'up')" 
                                                    ...
                                                    <button onclick="moverTestimonio(<?php echo e($testimonio->id); ?>, 'down')" 
                                                            class="mover-btn bg-blue-500 hover:bg-blue-600 text-white px-2 py-1 rounded text-xs transition-colors disabled:bg-gray-500 disabled:cursor-not-allowed"
                                                            title="Mover abajo">
                                                        ↓
                                                    </button>
                                            ...
                                            <!-- Nombre -->
                                            <td class="px-4 py-4 text-sm text-gray-300"><?php echo e($testimonio->nombre); ?></td>
                                            
                                            <!-- Sede -->
                                            <td class="px-4 py-4 text-sm text-gray-300"><?php echo e($testimonio->sede); ?></td>
                                            
                                            <!-- Carrera -->
                                            <td class="px-4 py-4 text-sm text-gray-300">
                                                <?php echo e(Str::limit($testimonio->carrera, 30)); ?>

                                            </td>
                                            
                                            <!-- Tiempo -->
                                            <td class="px-4 py-4 text-sm text-gray-300"><?php echo e($testimonio->tiempo_testimonio); ?> meses</td>
                                            
                                            <!-- Estado -->
                                            <td class="px-4 py-4">
                                                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium <?php echo e($testimonio->visible ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'); ?>">
                                                    <?php echo e($testimonio->visible ? 'Visible' : 'Oculto'); ?>
                                            ...
                                            <td class="px-4 py-4">
                                                <div class="flex space-x-2">
                                                    <!-- Cambiar Visibilidad -->
                                                    <button onclick="toggleVisibility(<?php echo e($testimonio->id); ?>, <?php echo e($testimonio->visible ? 'false' : 'true'); ?>)" 
                                                            class="<?php echo e($testimonio->visible ? 'bg-yellow-500 hover:bg-yellow-600' : 'bg-green-500 hover:bg-green-600'); ?> text-white px-3 py-2 rounded text-sm transition-colors"
                                                            title="<?php echo e($testimonio->visible ? 'Ocultar testimonio' : 'Mostrar testimonio'); ?>">
                                                        <?php if($testimonio->visible): ?>
                                                    ...
                                                    <!-- Editar -->
                                                    <button onclick="editTestimonio(<?php echo e($testimonio->id); ?>)" 
                                                    ...
                                                    <!-- Eliminar -->
                                                    <form action="<?php echo e(route('admin.testimonios.destroy', $testimonio->id)); ?>" method="POST" onsubmit="return confirmDelete(event)" class="inline">
                                                        <?php echo csrf_field(); ?>
    ...
    <div id="testimonioModal" class="fixed inset-0 bg-black bg-opacity-50 hidden z-50">
        <div class="flex items-center justify-center min-h-screen p-2 sm:p-4">
            <div class="bg-gray-800 rounded-lg p-1 sm:p-6 w-full max-w-[240px] sm:max-w-md">
                ...
                <form id="testimonioForm" action="<?php echo e(route('admin.testimonios.store')); ?>" method="POST" enctype="multipart/form-data" onsubmit="return handleFormSubmit(event)">
                    <?php echo csrf_field(); ?>
    ...
    <script>
        ...
        function openModal() {
            ...
            document.getElementById('testimonioForm').action = '<?php echo e(route("admin.testimonios.store")); ?>';
            isEditMode = false;
        }
...
<?php endif; ?><?php /**PATH /home/fede/Desktop/itca-laravel/resources/views/admin/testimonios.blade.php ENDPATH**/ ?>