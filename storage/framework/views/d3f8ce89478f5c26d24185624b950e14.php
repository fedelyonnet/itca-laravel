...
<?php $component->withAttributes([]); ?>
                        ...
                        <div class="overflow-x-auto">
                            <table class="min-w-full divide-y divide-gray-700">
                                ...
                                <tbody class="bg-gray-800 divide-y divide-gray-700">
                                    <?php $__currentLoopData = $beneficios->sortBy('orden'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $beneficio): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <!-- Orden -->
                                            <td class="px-4 py-4">
                                                <div class="flex flex-col items-center space-y-1">
                                                    <button onclick="moverBeneficio(<?php echo e($beneficio->id); ?>, 'up')" 
                                                    ...
                                                    <button onclick="moverBeneficio(<?php echo e($beneficio->id); ?>, 'down')" 
                                                            class="mover-btn bg-blue-500 hover:bg-blue-600 text-white px-2 py-1 rounded text-xs transition-colors disabled:bg-gray-500 disabled:cursor-not-allowed"
                                                            title="Mover abajo">
                                                        ↓
                                                    </button>
                                            ...
                                            <td class="px-4 py-4">
                                                <div class="relative group" 
                                                    ...
                                                    <div class="w-16 h-16 bg-gray-500 rounded overflow-hidden mx-auto cursor-pointer">
                                                        <?php if($beneficio->imagen_desktop): ?>
                                                            <img src="<?php echo e(asset('storage/' . $beneficio->imagen_desktop)); ?>" 
                                                                 alt="Desktop" 
                                            ...
                                            <td class="px-4 py-4">
                                                <div class="relative group" 
                                                     ...
                                                     @mouseleave="showTooltip = false">
                                                    <div class="w-16 h-16 bg-gray-500 rounded overflow-hidden mx-auto cursor-pointer">
                                                        <?php if($beneficio->imagen_mobile): ?>
                                                            <img src="<?php echo e(asset('storage/' . $beneficio->imagen_mobile)); ?>" 
                                                                 alt="Mobile" 
                                                                 class="w-full h-full object-cover">
                                                        <?php else: ?>
                                                            <div class="flex items-center justify-center h-full text-gray-400">
                                            ...
                                            <!-- Título Línea 1 -->
                                            <td class="px-4 py-4">
                                                <div class="text-sm font-medium text-white"><?php echo e($beneficio->titulo_linea1); ?></div>
                                            </td>
                                            
                                            <!-- Título Línea 2 -->
                                            <td class="px-4 py-4">
                                                <div class="text-sm font-medium text-white"><?php echo e($beneficio->titulo_linea2); ?></div>
                                            </td>
                                            ...
                                            <td class="px-4 py-4">
                                                <div class="text-sm text-gray-300">
                                                    <?php if($beneficio->tipo_accion === 'link' && $beneficio->url && $beneficio->texto_boton): ?>
                                                        <!-- Es un link con texto personalizado -->
                                                        <div>
                                                            <div class="text-gray-300">
                                                                <span class="text-gray-400">Texto visible: </span><?php echo e($beneficio->texto_boton); ?>

                                                            </div>
                                                            <div class="text-xs text-gray-400 mt-1"><?php echo e(Str::limit($beneficio->url, 40)); ?></div>
                                                        </div>
                                                    <?php elseif($beneficio->tipo_accion === 'button' && $beneficio->url): ?>
                                                        <!-- Es un botón -->
                                                        <div>
                                                            <div class="text-gray-300">Botón</div>
                                                            <div class="text-xs text-gray-400 mt-1"><?php echo e(Str::limit($beneficio->url, 40)); ?></div>
                                                        </div>
                                                    <?php elseif($beneficio->tipo_accion === 'none'): ?>
                                                        <!-- Sin link -->
                                                        <span class="text-gray-500">Sin link</span>
                                                    <?php else: ?>
                                                        <!-- Fallback para datos legacy -->
                                                        <?php if($beneficio->url && $beneficio->link): ?>
                                                            <div>
                                                                <div class="text-gray-300">
                                                                    <span class="text-gray-400">Texto visible: </span><?php echo e($beneficio->link); ?>

                                                                </div>
                                                                <div class="text-xs text-gray-400 mt-1"><?php echo e(Str::limit($beneficio->url, 40)); ?></div>
                                                            </div>
                                                        <?php elseif($beneficio->url && !$beneficio->link): ?>
                                                            <div>
                                                                <div class="text-gray-300">Botón</div>
                                                                <div class="text-xs text-gray-400 mt-1"><?php echo e(Str::limit($beneficio->url, 40)); ?></div>
                                                            </div>
                                            ...
                                            <td class="px-4 py-4">
                                                <div class="flex space-x-2">
                                                    <!-- Editar -->
                                                    <button onclick="editBeneficio(<?php echo e($beneficio->id); ?>)" 
                                                    ...
                                                    <!-- Eliminar -->
                                                    <form action="<?php echo e(route('admin.beneficios.destroy', $beneficio->id)); ?>" method="POST" onsubmit="return confirmDelete(event)" class="inline">
                                                        <?php echo csrf_field(); ?>
    ...
    <div id="modalAgregarBeneficio" class="fixed inset-0 bg-black bg-opacity-50 hidden z-50">
            ...
            <div class="bg-gray-800 rounded-lg p-1 sm:p-6 w-full max-w-[240px] sm:max-w-md">
                <div class="flex justify-between items-center mb-1 sm:mb-4">
                    ...
                    <button onclick="closeModal()" class="text-gray-400 hover:text-white">
                        ...
                        <form id="modalForm" action="<?php echo e(route('admin.beneficios.store')); ?>" method="POST" enctype="multipart/form-data" onsubmit="return handleFormSubmit(event)">
                            <?php echo csrf_field(); ?>
        ...
        function openModal() {
            ...
            document.getElementById('modalForm').action = '<?php echo e(route("admin.beneficios.store")); ?>';
        ...
        function editBeneficio(id) {
            ...
            fetch(`/admin/beneficios/${id}/data`)
                ...
                .then(data => {
                    ...
                    if (modalForm) {
                        modalForm.action = '<?php echo e(route("admin.beneficios.update", ":id")); ?>'.replace(':id', id);
...
<?php endif; ?>
<?php /**PATH /home/fede/Desktop/itca-laravel/resources/views/admin/beneficios.blade.php ENDPATH**/ ?>