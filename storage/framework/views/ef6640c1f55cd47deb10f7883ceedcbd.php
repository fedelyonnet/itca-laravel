...
<?php $component->withAttributes([]); ?>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('build/assets/backoffice-eMmMkJb6.css')); ?>">
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="w-full bg-gray-600 rounded relative desktop-hero-img1">
                                ...
                                <div class="absolute top-2 right-2 text-white px-2 py-1 rounded text-xs hero-badge" style="background-color: rgba(0, 0, 0, 0.4);">
                                    <div class="font-medium"><?php echo e($badges['desktop']['img1']['title']); ?></div>
                                    <div class="text-gray-300"><?php echo e($badges['desktop']['img1']['size']); ?></div>
                                </div>
                            ...
                            <div class="flex gap-4">
                                ...
                                <div class="flex-1 bg-gray-600 rounded relative desktop-hero-img2">
                                    <!-- Badge flotante -->
                                    <div class="absolute top-2 right-2 text-white px-2 py-1 rounded text-xs hero-badge" style="background-color: rgba(0, 0, 0, 0.4);">
                                        <div class="font-medium"><?php echo e($badges['desktop']['img2']['title']); ?></div>
                                        <div class="text-gray-300"><?php echo e($badges['desktop']['img2']['size']); ?></div>
                                    </div>
                                ...
                                <div class="flex-1 bg-gray-600 rounded relative desktop-hero-video">
                                    <!-- Badge flotante -->
                                    <div class="absolute top-2 right-2 text-white px-2 py-1 rounded text-xs hero-badge" style="background-color: rgba(0, 0, 0, 0.4);">
                                        <div class="font-medium"><?php echo e($badges['desktop']['video']['title']); ?></div>
                                        <div class="text-gray-300"><?php echo e($badges['desktop']['video']['size']); ?></div>
                                    </div>
                    ...
                    <div style="flex: 1; display: flex; flex-direction: column; gap: 20px;">
                        ...
                        <div class="grid grid-cols-3 gap-4">
                            ...
                            <div class="w-full bg-gray-600 rounded relative mobile-hero-container">
                                <!-- Badge flotante -->
                                <div class="absolute top-2 right-2 text-white px-2 py-1 rounded text-xs hero-badge" style="background-color: rgba(0, 0, 0, 0.4);">
                                    <div class="font-medium"><?php echo e($badges['mobile']['img1']['title']); ?></div>
                                    <div class="text-gray-300"><?php echo e($badges['mobile']['img1']['size']); ?></div>
                                </div>
                            ...
                            <div class="w-full bg-gray-600 rounded relative mobile-hero-container">
                                <!-- Badge flotante -->
                                <div class="absolute top-2 right-2 text-white px-2 py-1 rounded text-xs hero-badge" style="background-color: rgba(0, 0, 0, 0.4);">
                                    <div class="font-medium"><?php echo e($badges['mobile']['img2']['title']); ?></div>
                                    <div class="text-gray-300"><?php echo e($badges['mobile']['img2']['size']); ?></div>
                                </div>
                            ...
                            <div class="w-full bg-gray-600 rounded relative mobile-hero-container">
                                <!-- Badge flotante -->
                                <div class="absolute top-2 right-2 text-white px-2 py-1 rounded text-xs hero-badge" style="background-color: rgba(0, 0, 0, 0.4);">
                                    <div class="font-medium"><?php echo e($badges['mobile']['video']['title']); ?></div>
                                    <div class="text-gray-300"><?php echo e($badges['mobile']['video']['size']); ?></div>
                                </div>
                        ...
                        <div style="background: #374151; padding: 20px; border-radius: 8px; height: fit-content;">
                            <div class="flex items-center justify-between mb-4">
                                ...
                                <!-- Checkbox Visible -->
                                <form action="<?php echo e(route('admin.sticky-bar.update')); ?>" method="POST" class="inline">
                                    <?php echo csrf_field(); ?>
                                    <div class="flex items-center">
                                        <input type="checkbox" name="visible" id="visible" value="1" 
                                               <?php echo e($stickyBar->visible ? 'checked' : ''); ?>

                                               class="mr-2" onchange="this.form.submit()">
                                        <label for="visible" class="text-white text-sm">Visible</label>
                                        <input type="hidden" name="texto" value="<?php echo e($stickyBar->texto); ?>">
                                        <input type="hidden" name="color" value="<?php echo e($stickyBar->color); ?>">
                                    </div>
                                </form>
                            </div>
                            ...
                            <form action="<?php echo e(route('admin.sticky-bar.update')); ?>" method="POST" class="space-y-4">
                                <?php echo csrf_field(); ?>
                                
                                <!-- Input hidden para el estado del checkbox visible -->
                                <input type="hidden" name="visible" id="visibleHidden" value="<?php echo e($stickyBar->visible ? '1' : '0'); ?>">
                                ...
                                <div class="space-y-1">
                                    ...
                                    <input type="text" name="texto" id="texto" 
                                           ...
                                           value="<?php echo e($stickyBar->texto); ?>">
                                </div>
                                ...
                                <div class="space-y-1">
                                    ...
                                    <input type="text" name="texto_url" id="texto_url" 
                                           ...
                                           value="<?php echo e($stickyBar->texto_url); ?>">
                                </div>
                                ...
                                <div class="space-y-1">
                                    ...
                                    <input type="url" name="url" id="url" 
                                           ...
                                           value="<?php echo e($stickyBar->url); ?>">
                                </div>
                                    ...
                                    <div class="flex gap-4">
                                        ...
                                        <div class="flex-1" style="width: 80%;">
                                            <div class="relative">
                                                ...
                                                <input type="hidden" name="color" id="selectedColor" value="<?php echo e($stickyBar->color); ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="flex flex-col justify-center" style="width: 20%;">
                                            <div class="w-full h-8 rounded-lg border border-gray-400 relative flex items-center justify-center" 
                                                 id="colorPreview"
                                                 style="background-color: <?php echo e($stickyBar->color); ?>;">
                                                <div class="text-white text-xs font-mono font-bold" style="text-shadow: 1px 1px 2px rgba(0,0,0,0.8);"><?php echo e($stickyBar->color); ?></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <script>
                                ...
                                document.addEventListener('DOMContentLoaded', function() {
                                    ...
                                    const currentColor = '<?php echo e($stickyBar->color); ?>';
                                    if (currentColor) {
