...
<?php $component->withAttributes([]); ?>
                    ...
                    <div class="flex justify-between items-center mb-6">
                        <div>
                            ...
                            <p class="text-sm text-gray-400 mt-1">
                                Partners: <?php echo e($partners->count()); ?>
                                        ...
                                        <tr>
                                            ...
                                            <td class="px-4 py-4 text-center">
                                                <div class="flex flex-col items-center space-y-1">
                                                    <button onclick="moverPartner(<?php echo e($partner->id); ?>, 'up')" 
                                                    ...
                                                    <button onclick="moverPartner(<?php echo e($partner->id); ?>, 'down')" 
                                                            class="mover-btn bg-blue-500 hover:bg-blue-600 text-white px-2 py-1 rounded text-xs transition-colors disabled:bg-gray-500 disabled:cursor-not-allowed"
                                                            title="Mover abajo">
                                                        ↓
                                                    </button>
                                            ...
                                            <!-- URL -->
                                            <td class="px-4 py-4 text-sm text-gray-300 text-center" title="<?php echo e($partner->url); ?>">
                                                <a href="<?php echo e($partner->url); ?>" target="_blank" class="text-blue-400 hover:text-blue-300">
                                                    <?php echo e(Str::limit($partner->url, 30)); ?>
                                            ...
                                            <td class="px-4 py-4 text-center">
                                                <div class="flex space-x-2 justify-center">
                                                    <!-- Editar -->
                                                    <button onclick="editPartner(<?php echo e($partner->id); ?>)" 
                                                    ...
                                                    <!-- Eliminar -->
                                                    <form action="<?php echo e(route('admin.partners.destroy', $partner->id)); ?>" method="POST" onsubmit="return confirmDelete(event)" class="inline">
                                                        <?php echo csrf_field(); ?>
        ...
        <div class="flex items-center justify-center min-h-screen p-4">
            <div class="bg-gray-800 rounded-lg shadow-xl max-w-md w-full">
                <div class="p-6">
                    ...
                    <form id="partnerForm" action="<?php echo e(route('admin.partners.store')); ?>" method="POST" enctype="multipart/form-data" onsubmit="return handleFormSubmit(event)">
                        <?php echo csrf_field(); ?>
    ...
    <script>
        ...
        function openModal() {
            ...
            document.getElementById('partnerForm').action = '<?php echo e(route("admin.partners.store")); ?>';
            isEditMode = false;
        }
...
<?php endif; ?><?php /**PATH /home/fede/Desktop/itca-laravel/resources/views/admin/partners.blade.php ENDPATH**/ ?>