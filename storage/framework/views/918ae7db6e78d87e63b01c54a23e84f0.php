        ...
        <section class="lista-carreras">
            <div class="lista-carreras-container">
                ...
                <div class="lista-carreras-content">
                    <?php $__currentLoopData = $carreras; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $carrera): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="carrera-wrapper carrera-wrapper-<?php echo e(Str::slug($carrera->nombre)); ?>">
                        <div class="carrera-container carrera-<?php echo e(Str::slug($carrera->nombre)); ?>">
                                ...
                                <div class="carrera-title">
                                    <h3>
                                        ...
                                        <div class="carrera-title-line2">
                                            ...
                                            ?>
                                            <?php echo e($resto); ?> <span class="carrera-title-highlight"><?php echo e($ultimaPalabra); ?></span>
                                        </div>
                                    </h3>
                                </div>
                                <div class="carrera-text">
                                    <p><?php echo e($carrera->descripcion); ?></p>
                                </div>
                            ...
                            <div class="carrera-right">
                                <div class="carrera-image">
                                    ...
                                    <img src="<?php echo e(asset('storage/' . $carrera->ilustracion_desktop)); ?>" alt="<?php echo e($carrera->nombre); ?>" class="carreras-image-desktop" style="display: block;" />
                                    <!-- Imagen Mobile (solo visible en mobile) -->
                                    <img src="<?php echo e(asset('storage/' . $carrera->ilustracion_mobile)); ?>" alt="<?php echo e($carrera->nombre); ?>" class="carreras-image-mobile" style="display: none;" />
                                    <div class="carreras-modalidad-badge carreras-modalidad-badge-desktop">
                                        <span class="carreras-modalidad-text">Modalidad: <strong>
                                            <?php if($carrera->modalidad_online && $carrera->modalidad_presencial): ?>
                                                Presencial / Online
                                            <?php elseif($carrera->modalidad_presencial): ?>
                                                Presencial
                                            <?php else: ?>
                                                Online
                                            <?php endif; ?>
                    ...
                    <div class="swiper beneficios-swiper">
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide beneficios-carousel-slide">
                                <img src="<?php echo e(asset('storage/' . $beneficio->imagen_desktop)); ?>" alt="<?php echo e($beneficio->titulo); ?>" class="beneficios-slide-img-desktop" />
                                <img src="<?php echo e(asset('storage/' . $beneficio->imagen_mobile)); ?>" alt="<?php echo e($beneficio->titulo); ?>" class="beneficios-slide-img-mobile" />
                                <div class="beneficios-slide-content beneficios-slide-<?php echo e(Str::slug($beneficio->titulo)); ?>">
                                    <div class="beneficios-slide-main">
                                        <div class="beneficios-slide-title">
                                            <div class="beneficios-slide-line1"><?php echo e($beneficio->titulo); ?></div>
                                            <div class="beneficios-slide-line2"><?php echo e($beneficio->subtitulo); ?></div>
                                        </div>
                                    ...
                                    <div class="beneficios-slide-bottom">
                                        <div class="beneficios-slide-link <?php echo e($beneficio->mostrar_boton ? 'beneficios-slide-link-visible' : 'beneficios-slide-link-hidden'); ?>">
                                            <a href="<?php echo e($beneficio->url_boton); ?>"><?php echo e($beneficio->texto_boton); ?></a>
                                        </div>
                                        <div class="beneficios-slide-icon <?php echo e($beneficio->mostrar_boton ? 'beneficios-slide-icon-hidden' : 'beneficios-slide-icon-visible'); ?>">
                                            <a href="<?php echo e($beneficio->url_boton); ?>" class="beneficios-slide-icon-btn">
                    ...
                    <div class="partners-slider">
                        ...
                        <div>
                            <a href="<?php echo e($partner->url); ?>" target="_blank" class="partners-logo">
                                <img src="<?php echo e(asset('storage/' . $partner->logo)); ?>" alt="<?php echo e($partner->nombre ?? 'Partner'); ?>">
                            </a>
                        </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php /**PATH /home/fede/Desktop/itca-laravel/resources/views/carreras.blade.php ENDPATH**/ ?>